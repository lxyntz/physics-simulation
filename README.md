...
基于2022新课标，专为初中物理教学设计的交互式可视化模拟平台。通过直观的动画和交互控制，帮助学生更好地理解物理概念和原理，培养科学思维和探究能力。
...
- 🏫 **基于新课标**：基于2022年初中物理新课标设计内容，紧贴教学需求
...
方法一：打开链接直接使用 <a href="https://lxyntz.github.io/physics-simulation/" target="_blank">physics-visuals</a>
